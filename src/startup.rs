...
pub async fn run(
    ...
    let redis_store = RedisSessionStore::new(redus_uri.expose_secret()).await?;
...
impl Application {
    pub async fn build(configuration: Settings) -> Result<Self, anyhow::Error> {
        ...
        let base_url = reqwest::Url::parse(configuration.email_client.base_url.as_str())
